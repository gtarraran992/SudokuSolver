...
const styles = StyleSheet.create({
  ...
  cellSelected: { backgroundColor: '#EEEDFE' },
  cellSameGroup: { backgroundColor: '#F1EFE8' },
  cellHighlightTechnique: { backgroundColor: '#E1F5EE' },
  cellHint: { backgroundColor: '#FAEEDA' },
  cellError: { backgroundColor: '#FCEBEB' },
  cellText: { fontSize: 16, color: '#888780' },
  textGiven: { color: '#2C2C2A', fontWeight: '600' },
  textUser: { color: '#185FA5', fontWeight: '500' },
